...
export default function StandalonePricingCalculator() {
  ...
  const downloadPrijzen = () => {
    const data = {
      ...
      notitie: "Complete prijsmatrix - gebruik deze data in je app"
    }
    ...
    a.href = url
    a.download = `prijsmatrix-${new Date().toISOString().split('T')[0]}.json`
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-red-600 text-white py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center gap-2">
            ...
            <p className="font-semibold">INTERN - Prijsmatrix voor Provider</p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold mb-2">Prijsmatrix Calculator</h1>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-yellow-50 border-2 border-yellow-300 rounded-lg p-4">
              ...
              <p className="text-sm text-yellow-800">Klik op groene "Download Matrix" knop bovenaan en stuur het bestand via email</p>
            </div>
          </div>
        </div>
      </div>
